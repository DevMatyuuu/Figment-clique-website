    ...
    <>
      {catalogData.map((item) => (
        <div key={item.id} className="flex flex-col w-full justify-center items-center bg-white text-black rounded-xl group cursor-pointer">
          <img src={item.image} alt={item.title} width="150" height="200" className="rounded-xl w-[250px] h-full object-cover group-hover:scale-105 duration-500 cursor-pointer" />
